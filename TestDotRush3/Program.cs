...
class Program
{
    /// <summary>
    /// Adds two numbers <br/>
    /// Similar to <see cref="Add3"/> but only add 2 numbers <br/>
    /// </summary>
    /// <param name="a">The first number, see <see cref="Console.WriteLine(string)"/> from <see cref="Console"/></param>
    /// <param name="b">The second number</param>
    /// <returns>The sum of the two numbers</returns>
    /// <remarks>
    /// This method adds two numbers and returns the sum. <br/>
    /// Some other important note: <br/>
    /// This method is similar to <see cref="Add3"/> but only add 2 numbers.
    /// </remarks>
    ...
    /// Similar to <see cref="Add(int, int)"/> but only add 3 numbers <br/>
    /// </summary>
